										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-11.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-11.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-10.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-10.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-18.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-18.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-12.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-12.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-14.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-14.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-16.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-16.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-15.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-15.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('{{asset('assets')}}/demo/portfolio/pf-17.jpg');">
														<img src="{{asset('assets')}}/demo/portfolio/pf-17.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
							...
							<div class="carousel-items">
								...
								<div class="carousel-item is-active">
									...
									<div class="testimonial testimonial-whole-filled testimonial-whole-shadowed text-left testimonial-details-sm testimonial-avatar-sm">
										...
										<div class="testimonial-details">
											<figure class="avatar ">
												<img src="{{asset('assets')}}/demo/testimonials/testi-3.png" alt="Suke Tran">
											</figure>
								...
								<div class="carousel-item">
									...
									<div class="testimonial testimonial-whole-filled testimonial-whole-shadowed text-left testimonial-details-sm testimonial-avatar-sm">
										...
										<div class="testimonial-details">
											<figure class="avatar ">
												<img src="{{asset('assets')}}/demo/testimonials/testi-4.png" alt="Suke Tran">
											</figure>
											<div class="testimonial-info">
												<h5>Suke Tran</h5>
												<h6 class="font-weight-normal">Sumo Founder</h6>
								...
								<div class="carousel-item">
									...
									<div class="testimonial testimonial-whole-filled testimonial-whole-shadowed text-left testimonial-details-sm testimonial-avatar-sm">
										...
										<div class="testimonial-details">
											<figure class="avatar">
												<img src="{{asset('assets')}}/demo/testimonials/testi-5.png" alt="Suke Tran">
											</figure>
											<div class="testimonial-info">
												<h5>Suke Tran</h5>
												<h6 class="font-weight-normal">Sumo Founder</h6>
							...
							<div class="liquid-blog-grid row">
								...
								<div class="lqd-column col-md-4">
									<article class="liquid-lp">
										<figure class="liquid-lp-media rounded">
											<a href="#">
												<img src="{{asset('assets')}}/demo/blog/blog-6.jpg" alt="Blog Post">
											</a>
										</figure>
								...
								<div class="lqd-column col-md-4">
									<article class="liquid-lp">
										<figure class="liquid-lp-media rounded">
											<a href="#">
												<img src="{{asset('assets')}}/demo/blog/blog-7.jpg" alt="Blog Post">
											</a>
										</figure>
										<header class="liquid-lp-header">
											<h2 class="entry-title liquid-lp-title h5">
								...
								<div class="lqd-column col-md-4">
									<article class="liquid-lp category-news category-rounded">
										<figure class="liquid-lp-media rounded">
											<a href="#">
												<img src="{{asset('assets')}}/demo/blog/blog-8.jpg" alt="Blog Post">
											</a>
										</figure>
										<header class="liquid-lp-header">
											<h2 class="entry-title liquid-lp-title h5">
